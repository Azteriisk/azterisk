...
export function SatelliteOrbit({
  ...
  const bubbleRadius = 18; // 36px diameter
  // Orbit radius from node center to satellite center
      ...
      {technologies.map((tech, index) => {
        ...
        return (
          <React.Fragment key={tech.id}>
            {/* Connecting Glowing Ray Line directly from main circle to satellite center */}
            <svg
            ...
            <motion.div
              ...
              className="absolute pointer-events-auto group z-30 flex items-center justify-center cursor-pointer"
              style={{
                left: '50%',
                top: '50%',
            ...
            >
              ...
              <div
                className="w-full h-full rounded-full flex items-center justify-center relative cosmic-wobble-subtle transition-all duration-200 transform group-hover:scale-125"
                style={{
              ...
              >
                <TechIcon techId={tech.id} color={techColor} size={18} />
              </div>
              ...
              <div className="absolute left-1/2 -bottom-8 -translate-x-1/2 opacity-0 group-hover:opacity-100 pointer-events-none transition-all duration-150 z-40 whitespace-nowrap">
                <div
                  className="px-2.5 py-0.5 rounded text-[10px] font-mono flex items-center gap-1.5 backdrop-blur-md shadow-xl border"
                  style={{
                    backgroundColor: 'rgba(5, 5, 12, 0.95)',
                    borderColor: `${techColor}66`,
                    color: '#ffffff',
                  }}
                >
